...
import com.sobattani.MainActivity;
...
public class MyGcmPushReceiver extends GcmListenerService {
    ...
    public void onMessageReceived(String from, Bundle bundle) {
        ...
        if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
            ...
            Intent resultIntent;
            if (message.contains("menyukai") || message.contains("mengomentari")) {
                System.out.println("UserId : "+strUserId);
                resultIntent = new Intent(getApplicationContext(), ShowProfileActivity.class);
                resultIntent.putExtra("UserId", strUserId);
            } else {
