...
import com.sobattani.adapter.RankAdapter;

import org.json.JSONArray;

public class RankFragment extends Fragment implements ForumAdapter.ForumAdapterListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.rank_fragment, container, false);
    ...
    public void getAllData() {
        ...
        String url = Referensi.url + "/getRank.php";
        JsonArrayRequest jsObjRequest = new JsonArrayRequest(url, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                rankAdapter = new RankAdapter(mParentActivity, response);
                itemList.setAdapter(rankAdapter);
            }
